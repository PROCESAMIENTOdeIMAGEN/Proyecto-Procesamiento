...
exports.ImageTypeB = void 0;
var _1 = require(".");
var ImageTypeB = /** @class */ (function () {
    /**  Constructor general
    ...
    */
    function ImageTypeB(sc, img, w, h, data) {
        if (img) {
            this._width = img.width;
            this._height = img.height;
            var tamWidth = this._width;
            var tamHeight = this._height;
            var posicionX = (_1.TamCanvasWidth - tamWidth) / 2;
            var posicionY = (_1.TamCanvasHeight - tamHeight) / 2;
            this.imageData = sc.getImageData(posicionX + 1, posicionY + 1, this._width, this._height);
            console.log("con", this.imageData);
        }
        else {
            this._width = w;
            this._height = h;
            // console.log(`ESTE ES EL ANCHO${this._width} EL ALTO ES ${this._height}`)
    ...
    ImageTypeB.prototype.getColorIndicesForCoord = function (x, y) {
     ...
     */
    ImageTypeB.prototype.dataToImageArray2D = function () {
        var position;
    ...
    ImageTypeB.prototype.dataTextToImageArray2D = function () {
        var position;
        for (var i = 0; i < this._height; i++) {
            for (var j = 0; j < this._width; j++) {
                position = this.getColorIndicesForCoord(j, i);
     ...
     */
    ImageTypeB.prototype.imageArray2DtoDataB = function (sc, arrImage) {
        var position;
        for (var i = 0; i < this._height; i++) {
            for (var j = 0; j < this._width; j++) {
                position = this.getColorIndicesForCoord(j, i);
        ...
        var posicionX = (_1.TamCanvasWidth - tamWidth) / 2;
        var posicionY = (_1.TamCanvasHeight - tamHeight) / 2;
        sc.putImageData(this.imageData, posicionX + 1, posicionY);
        //sc.fillRect(10,10,100,100)
    };
    /** Covierte un arreglo 3d de la imagen a un objeto data, si el argumento existe se dibuja
     * @sc elemento Canas donde se desa dibujar la data
     */
    ImageTypeB.prototype.newImageArray2DtoData = function (sc, arrImage) {
        var position;
     ...
     */
    ImageTypeB.prototype.imageArray2DtoDataWithResizing = function (sc, arrImage) {
    ...
    ImageTypeB.prototype.initArray = function () {
    ...
    ImageTypeB.prototype.getArrayImg = function () {
        return this.arrImage;
    };
    ImageTypeB.prototype.getWidth = function () {
        return this._width;
    };
    ImageTypeB.prototype.getHeight = function () {
        return this._height;
    };
    return ImageTypeB;
}());
exports.ImageTypeB = ImageTypeB;
